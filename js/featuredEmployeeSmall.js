...
$('#paginationfeaturedemployeeSmall').on('click','a',function(e){
				e.preventDefault(); 
			...
			function loadPagination(pagno){
				$.ajax({
					...
					success: function(response){
						...
						$('#paginationfeaturedemployeeSmall').html(response.pagination);
			...
			function createTable(result,sno){
				sno = Number(sno);
				$('#featuredemployeeSmall ubody').empty();
				...
				for(index in result){
					...
					$('#featuredemployeeSmall ubody').append(li);
					}
