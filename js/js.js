...
// Detect pagination click
			...
			function createTable(result,sno){
				...
				for(index in result){
					...
					var fresher = result[index].employee_fresher_experience;
					var fresher1 = atob(fresher);
					var fresher2 = atob(fresher1);
					...
					var tr = "<tr>";
					tr += "<td class='leftt mainname fontSize' ><a href='EmployeeDetailRecruiter?uid="+ link +"' style='color:#f15f43; text-decoration:none;'>"+ emp2 +"</a></td>";
					tr += "</tr>";
					tr += "<tr>";
					tr += "<td class='leftt fontSize'>"+ fresher2 +"</td>";
					tr +="</tr>";
					tr +="<tr>";
