//jquery for employerprofile line number 852
		$(document).ready(function(){
			...
			function loadPagination(pagno){
				$.ajax({
					url: 'https://get-job.online/employee/jobsPostedPagination/'+pagno,
					type: 'get',
					dataType: 'json',
			...
			function createTable(result,sno){
				...
				for(index in result){
					...
					var tr = "<tr>";
					tr += "<td class='leftt mainname'><a href='https://get-job.online/EmployeeJobDetail?uid="+ link +"' >"+ jobtitle +"</a></td>";
					tr += "</tr>";
					tr += "<tr>";
