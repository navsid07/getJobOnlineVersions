	...
	public function login()
	{
		...
		if($this->input->get('referralrecruiter'))
 	{
			...
			if(!empty($this->session->userdata('pyuemail')))
		{
			...
			redirect(base_url().'recruiter/dashboard');//$this->load->view('dashboard',['employee'=>$employee]);
		}
		else
		{
			if(!empty($this->session->userdata('pyuemail')))
		...
		$this->load->view('recruiterlogin',['categories'=>$category,'employee'=>$employee,'randemployee'=>$randemployee]);
	}
}
    ...
    <tbody class="mcnButtonBlockOuter">
        <tr>
            <td style="padding-top:0; padding-right:18px; padding-bottom:18px; padding-left:18px;" valign="top" align="center" class="mcnButtonBlockInner">
                <table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnButtonContentContainer" style="border-collapse: separate !important;border-radius: 3px;background-color: #F15F43;">
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Helvetica; font-size: 16px; padding: 10px;">
                                <a class="mcnButton " title="Verify Now" href="http://get-job.online/recruiter/verify/'.$to_encode.'/'.$hash.'" target="_self" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Verify Now</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
...
&nbsp;
           ...
           if($this->email->send())
           {
           	$this->session->set_flashdata('loginemail','In order to proceed further you need to verify your email address.An email has been sent to your email <b>'.$to.'</b>. Please Check your Inbox/Spam folder if the email appears in the spam folder. Please click on not spam for further flawless communication and proceed further by clicking on the link given in the email. If you have not received the email click below to send again Or if you wish to change your email address click below to change email. </br><div style="text-align:center; margin-top:10px;"><a href="https://www.get-job.online/recruiter/sendagainemail?email='.$to_encode.'& hash='.$hash.'" class="btn btn-success" style="margin-right:10px;">Send Again</a><a href="recruiter/recruiteremail/'.$to.'"  class="btn btn-info">Change Email</a></div>');
 ...
 else
   {
	...
	public function email()
	{
			...
			$to=$this->input->post('email');
			$to_result=$this->fetch->checkmailrecruiter($to);
                    ...
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Helvetica; font-size: 18px; padding: 13px;">
                                <a class="mcnButton " title="Change password" href="http://www.get-job.online/recruiter/changepassword/'.$to.'" target="_self" style="font-weight: bold;letter-spacing: -0.5px;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Change password</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
...
&nbsp;
	...
	public function changepassword()
	{
		 ...
		 $employee=$this->fetch->allemployee();
		 $this->load->view('changepasswordrecruiter',['email'=>$email,'employee'=>$employee]);	
	}
	...
	$password= $this->input->post('password');
	 ...
	 if($this->fetch->changepasswordrecruiter($data))
	 {
		...
		if(!empty($_POST['g-recaptcha-response']))
 {
		...
		if($emailexist==1)
			{
			$this->session->set_flashdata('emailexistemployee','Email you have enetered is registered as a employee.If you are employee then click <a href="https://www.get-job.online/employee/login">here</a> for signin.');
		...
		else
		{
			...
			//{
if (!empty($linkid)) {
					redirect(base_url().'recruiter/employerdetail?uid='.$linkid);
				}
...
public function rtest()
{
	...
	{
		$session=$this->session->userdata('recruiter_id');
		if(!empty($session))
		{
			$data=$this->fetch->fetchrecruiterprofile();
			$category=$this->fetch->fetchcategories();
...
<h4>Your job, JOB TITLE. Has been submitted successfully. It will be on the website for a month and if it crosses that time window it will be deleted automatically.&nbsp;If you wish to view the job posting please click below.</h4>
                    ...
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Helvetica; font-size: 16px; padding: 15px;">
                                <a class="mcnButton " title="VIEW APPOINTMENT" href="http://get-job.online/recruiter/jobdetailrecruiter?rid='.$id.'" target="_blank" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #F24934;">VIEW APPOINTMENT</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
                                                                ...
                                                                <td style="padding-top:5px; padding-right:10px; padding-bottom:5px; padding-left:9px;" align="left" valign="middle">
                                                                    <table align="left" width="" cellspacing="0" cellpadding="0" border="0">
                                                                        <tbody><tr>
                                                                                ...
                                                                                <td class="mcnFollowIconContent" align="center" width="24" valign="middle">
                                                                                    <a href="http://www.get-job.online" target="_blank"><img src="https://cdn-images.mailchimp.com/icons/social-block-v2/light-link-48.png" style="display:block;" class="" width="24" height="24"></a>
                                                                                </td>
    ...
    <tbody class="mcnTextBlockOuter">
        <tr>
                ...
                <table style="max-width:100%; min-width:100%;" class="mcnTextContentContainer" align="left" width="100%" cellspacing="0" cellpadding="0" border="0">
                    <tbody><tr>
                        ...
                        <td class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;" valign="top">
                            ...
                            <em>Copyright © 2017, All rights reserved.Designed and Managed by The Revew.</em>
                        </td>
                    </tr>
                </tbody></table>
				<!--[if mso]>
           ...
           if($this->email->send())
           {
           			$id=$this->insert->submitjob($input);
				$this->session->set_flashdata('submit','Your job successfully submitted');
				$this->session->set_flashdata('submit_class','alert-success');
				//redirect($_SERVER['HTTP_REFERER']);
				redirect(base_url().'recruiter/myjobs');
			}
			else
			{
				$this->session->set_flashdata('submit_failed','mail error');
				$this->session->set_flashdata('submit_failed_class','alert-danger');
				redirect($_SERVER['HTTP_REFERER']);
			}
           ...
           if($this->email->send())
           {
		  	...
		  	{
				$this->session->set_flashdata('submit_failed','Something went wrong please try again later');
				$this->session->set_flashdata('submit_failed_class','alert-danger');
				redirect($_SERVER['HTTP_REFERER']);
			}*/
	}
...
public function checkrepeatemail() {
	...
	$to=$this->input->post('email');
	$data=$this->fetch->checkmailrecruiter($to);
	if( $data=='success' )
	{
	...
	{
		$dd=$this->fetch->updateemail($to);
		$this->session->set_flashdata('email_success','In order to proceed further you need to verify your email address.An email has been sent to your email '.$to.'. Check your inbox and proceed further by clicking on the link given in the email. If you have not received the email click below. Or if you wish to change your email address click below. </br><div style="text-align:center; margin-top:10px;"><a href="https://www.get-job.online/recruiter/sendagainemail?email='.$to.'" class="btn btn-success" style="margin-right:10px;">Send Again</a></div>');
		$this->session->set_flashdata('email_success_class','alert-success');
		redirect($_SERVER['HTTP_REFERER']);
	}
   // $this->load->view('changerecruiteremail',['data'=>$data]);
}
            ...
            <td style="padding-top:0; padding-right:18px; padding-bottom:18px; padding-left:18px;" valign="top" align="center" class="mcnButtonBlockInner">
                <table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnButtonContentContainer" style="border-collapse: separate !important;border-radius: 3px;background-color: #F15F43;">
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Helvetica; font-size: 16px; padding: 10px;">
                                <a class="mcnButton " title="Verify Now" href="http://get-job.online/recruiter/verify/'.$too.'/'.$newhash.'" target="_self" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Verify Now</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
...
public function sendagainemail() {
	...
	$to_decode=base64_decode(base64_decode($to_decode));
	 $newhash=mt_rand();
            ...
            <td style="padding-top:0; padding-right:18px; padding-bottom:18px; padding-left:18px;" valign="top" align="center" class="mcnButtonBlockInner">
                <table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnButtonContentContainer" style="border-collapse: separate !important;border-radius: 3px;background-color: #F15F43;">
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Helvetica; font-size: 16px; padding: 10px;">
                                <a class="mcnButton " title="Verify Now" href="http://get-job.online/recruiter/verify/'.$to.'/'.$hash.'" target="_self" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Verify Now</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
...
&nbsp;
           ...
           if($this->email->send())
           {
           	...
           	$this->session->set_flashdata('emailagain_class','alert-success');
           	//redirect ($_SERVER['HTTP_REFERER']);
           	$this->update->updatehash($to,$newhash);
           	redirect (base_url().'recruiter/RegistrationMessage');
...
public function verify()
{
	...
	$this->load->view('verifyrecruiter',['data'=>$data]);
}
                    ...
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Arial; font-size: 16px; padding: 15px;">
                                <a class="mcnButton " title="Save Recruiter" href="http://www.get-job.online/employee/save/'.$uid.'/'.$rid.'" target="_blank" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Save Recruiter</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
                    ...
                    <tbody>
                        <tr>
                            <td class="mcnButtonContent" style="font-family: Arial; font-size: 16px; padding: 15px;" align="center" valign="middle">
                                <a class="mcnButton " title="View Recomended" href="http://www.get-job.online" target="_blank" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">View Recomended</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <td style="padding-top:0; padding-right:18px; padding-bottom:18px; padding-left:18px;" class="mcnButtonBlockInner" align="center" valign="top">
                <table class="mcnButtonContentContainer" style="border-collapse: separate !important;border-radius: 3px;background-color: #F15F43;" cellspacing="0" cellpadding="0" border="0">
                    <tbody>
                        <tr>
                            <td class="mcnButtonContent" style="font-family: Arial; font-size: 16px; padding: 15px;" align="center" valign="middle">
                                <a class="mcnButton " title="Visit Blog" href="http://www.blog.therevew.com" target="_blank" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Visit Blog</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
...
if($this->input->get('jid'))
{
	...
	$this->load->view('employerdetail',['applycheck'=>$applycheck,'fetchstatus'=>$fetchstatus,'jid'=>$jid,'data'=>$data,'categories'=>$category,'employee'=>$employee,'employe'=>$employe,'employer'=>$employer,'recruited'=>$recruited]);

}
else
{
	$this->load->view('employerdetail',['applycheck'=>$applycheck,'data'=>$data,'categories'=>$category,'employee'=>$employee,'employe'=>$employe,'employer'=>$employer,'recruited'=>$recruited]);
 ...
 $uidd=$this->session->userdata('recruitid');
 	...
 	else
 	{
 		...
 		$month= date("m");
 		$year= date("y");
 		$data=array('recruitcandidate_employee_id'=>$uidd, 'recruitcandidate_employer_id'=>$uid,'recruitcandidate_date'=>$date,'recruitcandidate_month'=>$month,'recruitcandidate_year'=>$year);
 		if($this->insert->recruitmodel($data))
 		{
			$this->update->decrementbalance();
 			$this->session->set_flashdata('recruit','<strong>Success!</strong> You have successfully recruit this candidate. Plesae Click on  button to download resume of this candidate.       <a href="https://www.get-job.online/recruiter/downloadresume?id='.$riid.'" target="_blank"><button type="button" class="alertbutton">Download Resume</button></a>');
...

 {
 	...
 	else
 	{
 		...
 		if($this->insert->recruitmodel($data))
 		{
 			...
 			$this->update->decrementbalance();
 			$this->session->set_flashdata('recruit','<strong>Success!</strong> You have successfully recruit this candidate. Plesae Click on  button to download resume of this candidate.       <a href="http://www.get-job.online/recruiter/download/"><button type="button" class="alertbutton">Download Resume</button></a>');
           	$this->session->set_flashdata('recruit_class','alert-success');
             	redirect(base_url().'recruiter/rredirect');
 		}
 	}
 }
                                                                ...
                                                                <td align="left" valign="middle" style="padding-top:5px; padding-right:10px; padding-bottom:5px; padding-left:9px;">
                                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" width="">
                                                                        <tbody><tr>
                                                                                ...
                                                                                <td align="center" valign="middle" width="24" class="mcnFollowIconContent">
                                                                                    <a href="http://www.get-job.online" target="_blank"><img src="https://cdn-images.mailchimp.com/icons/social-block-v2/light-link-48.png" style="display:block;" height="24" width="24" class=""></a>
                                                                                </td>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <em>Copyright © 2017 | All right reserved. Designed and managed by The Revew.</em><br>
<br>
&nbsp;
                        </td>
                    </tr>
...
// for short list employee
...

 {
 	...
 	$rid=$this->session->userdata('recruiter_id');
 	$data=[
	 	'shortlisted_employee_id'=>$uid,
	 	'shortlisted_employer_id'=>$rid
 	];
 	$insert=$this->insert->increment($data);
...
$singleid=$id;
	...
	if($result==null && $resultt==null)
	{
		...
		foreach ($resultt as $value) {
			...
			$this->load->view('shortlisted',['shortlistt'=>$shortlistcandidates,'data'=>'null','recruit'=>'null','profile'=>$profile,'categories'=>$category,'recruitresult'=>$resultt,'jobs'=>$jobs]);
		}
		elseif($result==null)
	{
		...
		foreach ($resultt as $value) {
			...
			$this->load->view('shortlisted',['shortlistt'=>$shortlistcandidates,'data'=>'null','recruit'=>$recruit,'profile'=>$profile,'categories'=>$category,'recruitresult'=>$resultt,'jobs'=>$jobs]);
		}
	...
	elseif($resultt==null)
	{
		...
		$this->load->view('shortlisted',['shortlistt'=>$shortlistcandidates,'data'=>$data,'recruit'=>'null','profile'=>$profile,'categories'=>$category,'recruitresult'=>$resultt,'jobs'=>$jobs]);
	...
	foreach ($result as $value) {
		...
		$this->load->view('shortlisted',['shortlistt'=>$shortlistcandidates,'data'=>$data,'recruit'=>$recruit,'profile'=>$profile,'categories'=>$category,'recruitresult'=>$resultt,'jobs'=>$jobs]);
}
}
else
{
...
public function deleteshortlisted()
{
	$id=$this->uri->segment(3);
		...
		$iid=$this->session->userdata('recruiter_id');
		if($this->delete->shortlisted($id,$iid))
		{
 ...
 public function search()
  {
  	...
  	if(empty($location) && empty($category))
  	{
  		...
  		$data=$this->search->searchcategory($job);
  		$ddata=$data['result'];
  		if($ddata==null)
  		{
  		...
  		$this->load->view('jobsearchresultrecruiter',['recruiter'=>$recruiter,'data'=>$result,'profile'=>$fetch,'categories'=>$categoryyy]);
  		}
  		if($ddata!=null)
  		{
  	...
  	if(empty($job) && empty($category))
  	{
  		...
  		$data=$this->search->searchlocationrecruiter($location);
  		$rresult=$data['result'];
  		if($rresult==null)
  		{
...
if(empty($job) && empty($location))
  	{
  		$categoryy=$this->fetch->fetchcategories();
  		$dataa=$this->search->searchemployeecategory($category);
  		$data=json_decode(json_encode($dataa), true);
  		$fetch=$this->fetch->fetchrecruiterprofile();
  		$this->load->view('jobsearchresultrecruiter',['recruiter'=>$recruiter,'data'=>$data,'profile'=>$fetch,'categories'=>$categoryy]);
  	...
  	if(!empty($location) && !empty($job) && empty($category))
  	{
  		...
  		$data=$this->search->searchbothrecruiter($location,$job);
  		$rresult=$data['result'];
  		if($rresult==null)
  		{
  			
  		$result=json_decode(json_encode($rresult), true);
  		$this->load->view('jobsearchresultrecruiter',['recruiter'=>$recruiter,'data'=>$result,'categories'=>$categoryyy]);
  		}
  		if($rresult!=null)
  		{
...
{	
	...
	$singleid=$this->session->userdata('recruiter_id');
	if(!empty($singleid))
	{
	...
	$data=$this->fetch->featutredrecruiter($singleid);
		...
		$this->load->view('myjobs',['max'=>$max,'rand'=>$randemployee,'data'=>$data,'categories'=>$category,'cat'=>$cat,'result'=>$result]);
                    ...
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Helvetica; font-size: 18px; padding: 18px;">
                                <a class="mcnButton " title="View new Jobs " href="https://www.get-job.online" target="_self" style="font-weight: bold;letter-spacing: -0.5px;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">View new Jobs </a>
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <td style="padding-top:0; padding-right:18px; padding-bottom:18px; padding-left:18px;" valign="top" align="center" class="mcnButtonBlockInner">
                <table border="0" cellpadding="0" cellspacing="0" class="mcnButtonContentContainer" style="border-collapse: separate !important;border-radius: 3px;background-color: #2BAADF;">
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Arial; font-size: 16px; padding: 15px;">
                                <a class="mcnButton " title="Continue to referral dashboard" href="https://www.get-job.online/referral/dashboard?referralrecruiter=referral" target="_blank" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Continue to referral dashboard</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
...
$this->email->message($body);
           if($this->email->send())
           {
				...
				$this->session->set_flashdata('applystatus','You are successfully decline job invitation');
				$this->session->set_flashdata('applystatus_class','alert alert-danger');
				redirect(base_url().'recruiter/jobdetailrecruiter?rid='.$jid);
			}
		}
            ...
            <td style="padding-top:0; padding-right:18px; padding-bottom:18px; padding-left:18px;" valign="top" align="center" class="mcnButtonBlockInner">
                <table border="0" cellpadding="0" cellspacing="0" class="mcnButtonContentContainer" style="border-collapse: separate !important;border-radius: 3px;background-color: #2BAADF;">
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Arial; font-size: 16px; padding: 15px;">
                                <a class="mcnButton " title="Visit Job" href="https://www.get-job.online/employee/jobdetail?uid='.$jid.'&signin=linkid" target="_blank" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Visit Job</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
                                                                ...
                                                                <td align="left" valign="middle" style="padding-top:5px; padding-right:10px; padding-bottom:5px; padding-left:9px;">
                                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" width="">
                                                                        <tbody><tr>
                                                                                ...
                                                                                <td align="center" valign="middle" width="24" class="mcnFollowIconContent">
                                                                                   <a href="https://www.facebook.com/sharer/sharer.php?u=https://www.get-job.online" target="_blank"><img src="https://cdn-images.mailchimp.com/icons/social-block-v2/color-facebook-48.png" style="display:block;" height="24" width="24" class=""></a>
                                                                                </td>
...
&url=https://www.get-job.online" target="_blank"><img src="https://cdn-images.mailchimp.com/icons/social-block-v2/color-twitter-48.png" style="display:block;" height="24" width="24" class=""></a>
                                                                                </td>
                                                                ...
                                                                <td align="left" valign="middle" style="padding-top:5px; padding-right:10px; padding-bottom:5px; padding-left:9px;">
                                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" width="">
                                                                        <tbody><tr>
                                                                                ...
                                                                                <td align="center" valign="middle" width="24" class="mcnFollowIconContent">
                                                                                    <a href="https://plus.google.com/share?url=https://www.get-job.online" target="_blank"><img src="https://cdn-images.mailchimp.com/icons/social-block-v2/color-googleplus-48.png" style="display:block;" height="24" width="24" class=""></a>
                                                                                </td>
            ...
            <td style="padding-top:0; padding-right:18px; padding-bottom:18px; padding-left:18px;" valign="top" align="center" class="mcnButtonBlockInner">
                <table border="0" cellpadding="0" cellspacing="0" class="mcnButtonContentContainer" style="border-collapse: separate !important;border-radius: 3px;background-color: #2BAADF;">
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Arial; font-size: 16px; padding: 15px;">
                                <a class="mcnButton " title="Continue to referral dashboard" href="https://www.get-job.online/referral/dashboard?referral=referral" target="_blank" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Continue to referral dashboard</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
...
$this->email->message($body);
           ...
           {
           	//echo 'success';
			$this->session->set_flashdata('applystatus','You are successfully Accept job invitation');
...
public function downloadresume()
{
	...
	else
	{
		...
		redirect(base_url().'recruiter/addbalance');
	}
...
public function updatejob()
{
	...
	$update=array('job_title'=>$title,
		'experience_required'=>$experience,
		'job_description'=>$description,
		'category'=>$category,
		'country'=>$country,
		'preffered_location'=>$location,
		'lowest_education'=>$qualification,
		'payscale'=>$payscale);
