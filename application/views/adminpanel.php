	    ...
	    <!--/.navbar-collapse-->
				...
				<div class="container">
					<div class="col-md-offset-3 col-md-6" style="margin-top:4%;">
												...
												<div class="col-md-6">	<a href="<?= base_url(); ?>AdminAgain/allemployer" ><button type="button">
														Employee
													</button></a></div>

													<div class="col-md-6"><a href="<?= base_url(); ?>AdminAgain/allrecruiter" ><button type="button">
														Recruiter
													</button></a></div>
