		        ...
		        <li class="dropdown">
		            ...
		            <ul class="dropdown-menu">
			           ...
			           <li><a href="<?= base_url(); ?>AdminAgain/allrecruiter" >All recruiter</a></li>
			            	    ...
			            	    <li><a href="<?= base_url(); ?>admin/checkBoxmailAllrecruiter" >Send Chekckbox emails</a></li>
		        ...
		        <li class="dropdown">
		            ...
		            <ul class="dropdown-menu">
			          ...
			          <li><a href="<?= base_url(); ?>AdminAgain/allemployer" >All employee</a></li>
			            	    ...
			            	    <li><a href="<?= base_url(); ?>admin/checkBoxmailAllemployee" >Send Chekckbox emails</a></li>
...
<script type="application/javascript">
 function deleteRecruiter(id)
 {
    ...
    var paramstr=$("#deleterecruiter" + id).serialize();
   
    if($.post("<?php echo base_url();?>admin/deleterecruiter",
    paramstr))
    {
    ...
    function showConfirm(id)
 {
      ...
      $("#showConfirm" + id).hide(600);
      $("#confirmbox" + id).show(600);
   ...
   function hideconfirm(id)
 {
     ...
     $("#confirmbox" + id).hide(600);
      $("#showConfirm" + id).show(600);
 ...
 <script>
  $(document).ready(function(){
    ...
    {
      $.ajax({
        url:"<?php echo base_url(); ?>AdminAgain/fetchRecruiterAdmin",
        method:"POST",
