...
-->
 ...
 <div class="col-md-10  ">
     ...
     <div class="form-container">
        ...
        <form id="addArticle" method="post" enctype="multipart/form-data"> <!--onsubmit="return validateForm()">-->
          <div class="col-md-offset-2 col-md-8" style="margin-bottom:10px; text-align:center;">
            ...
            <div class="form-group col-md-12">
                   ...
                   <h1> <input type="text" name="heading" class="form-control" value="<?= base64_decode(base64_decode($value['employee_articleHeading'])); ?>" id="heading"/>
              </h1>
            </div>
        </div>
<input type="hidden" name="id" value="<?= $value['article_id']; ?>">
        <div class="row">
            <div class="form-group col-md-12">
              
           
                    <textarea name="body" id="mytxtarea" rows="20" class="form-control" ><?= base64_decode(base64_decode($value['employee_articleBody'])); ?></textarea>
...
<div id='err_msg' style='display: none'>  
  ...
  <div class="row">
            <div class="form-actions floatRight">
                ...
                <button type="button" id="addMore" class="btn btn-primary btn-sm">+ Add More</button>
    ...
    // disabled the submit button
       // $("#addMore").prop("disabled", true);
        ...
        $.ajax({
            ...
            url: "<?php echo base_url('employee/editarticle'); ?>",
            data: data,
            processData: false,
            contentType: false,
            cache: false,
