...
<!----font-Awesome-->
<script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/1/jquery.min.js"></script><script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
<script>
...
#categoryPagination a, #locationPagination a, #mostViewedPagination a, #citySearchPagination a, #startSearchPagination a {
    border-radius: 50%;
...
<ul id="breadcrumbs" style="margin-top:6%;"itemscope itemtype="http://schema.org/BreadcrumbList"><li itemprop="itemListElement" itemscope
      ...
      itemtype="http://schema.org/ListItem"><li><span itemprop="name">Job Search</span></li></ul>
		...
		<div class="single">  
      <div class="col-sm-8 follow_left background padding margin-bottom">
	<?php
...
?>
             ...
             <table class="tablewidth"  id='startSearchPaginationList'>

             	<thead class="radius">
				
					 <tr style="text-align:center;">
	 	<td><div id="startSearchLoading"><img src="<?= base_url(); ?>images/loading.gif" width="20%" height="10%" alt="loading"></img></div>
	
	 </td>
	</tr>

			</thead>
				<tbody class="follow_jobb"></tbody>
				
		</table>
		<div style='margin-top: 10px; text-align:center;' class="padding" id='startSearchPagination'></div>
		<?php
}
		?>
...
else
{
            ...
            foreach ($data11 as $value) 
		{
				?>
					...
					<div class="title">
						 <a href="<?= base_url(); ?>EmployeeJobDetail?uid=<?= $value['submitjob_id']; ?>"><h4 style="color:black;"><?= $value['submitjob_job_title']; ?></h4></a>
					...
					<div class="col-md-12">
							<a href="<?= base_url(); ?>JobVisitor?uid=<?= $value['submitjob_id']; ?>" class="btn regularButton marginleft">More>></a>
					</div>
             ...
             <table class="tablewidth background">
             	<tr><td> <h3 class="radius">Locations</h3></td></tr>
                        ...
                        <tr class="unread checked">
                            ...
                            <td class="padding hidden-xs" itemscope itemtype="http://schema.org/Place" style="text-transform:capitalize;">
                               <a href="<?= base_url(); ?>EmployeeSearching?location=<?= $value['submitjob_preffered_location']; ?>" style="text-decoration:none; color:#999999;"><span itemprop="name"><?= $value['submitjob_preffered_location']; ?></span></a>
                            </td>
                        </tr>
                        <?php
						}
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
					...
					<script src="<?= base_url() ?>js/startSearchPagination06.js"></script>