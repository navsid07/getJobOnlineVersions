...
?><title>Find a job and get recruited online | Get Job Onlineee</title>
...
<!--<link href="<?= base_url(); ?>css/bootstrap-3.1.1.min.css" rel='stylesheet' type='text/css'  media="all"/>-->
...
<?php
    ...
    include('footer.php');
?>
<input type="text" value="12233333" id="testinput">
</body>
<?php
