...
include 'fav.php';
?>
<title>Online job portal for job seekers and job providers | Recruiter Register :: Get-job.online</title>
...
<div class="container">
    <div class="single">  
	   <div class="form-container">
        <h2>Recruiter Registeration Form</h2>
        ...
        <form action="<?= base_url(); ?>suggestion/updaterecruiter" method="post" enctype="multipart/form-data" name"myForm" onsubmit="return validateForm()">
          <div class="row">
            <div class="form-group col-md-12">
                <label class="col-md-3 control-lable" for="firstName" >Company Name</label>
                <div class="col-md-9">
                    <input type="text" name="company_name" value="<?= base64_decode(base64_decode($value['company_name'])); ?>" class="form-control input-sm"/>
         ...
         <div class="row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-9">
                    <input type="text" name="established" value="<?= base64_decode(base64_decode($value['established'])); ?>" class="form-control input-sm"/>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-9">
                    <input type="text" name="contact" required="" value="<?= base64_decode(base64_decode($value['contact'])); ?>" class="form-control input-sm"/>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-9">
                    <input type="text" name="city" value="<?= base64_decode(base64_decode($value['city'])); ?>" class="form-control input-sm" required=""/>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-9">
                    <input type="text" name="state" value="<?= base64_decode(base64_decode($value['state'])); ?>" class="form-control input-sm" required=""/>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-9">
                    <select name="employee_strength" class="form-control input-sm" required="">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-9 sm_1">
                   <textarea cols="77" rows="6" name="address" id="address" onkeyup="myFunction()"   placeholder="Your address.."><?= base64_decode(base64_decode($value['address'])); ?></textarea><p id="addressresult" style="float:right;"><font color="red"><b>0</b></font></p>
         ...
         <div class="row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-9 sm_1">
                   <textarea cols="77" rows="6" value=" "  name="description" id="description" onkeyup="myFunction1()"  placeholder="Minimum 140 characters"><?= base64_decode(base64_decode($value['description'])); ?></textarea><p id="descriptionresult" style="float:right;"><font color="red"><b>0</b></font></p>
