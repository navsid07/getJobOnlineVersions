  ...
  gtag('config', 'AW-995257176');
	...
	<div class="container">
	    ...
	    <!--/.navbar-collapse-->
				...
				<div class="container">
					<div class="row" style="margin-top:4%;">
						...
						<div class="col-md-12 padding background">
							...
							<form action="<?= base_url(); ?>admin/testt" method="post">
						<?php
						...
						foreach ($data as $value) {
							...
							if (empty($value['member_since'])) {
							$membersince='Joining date not available';
							}
							elseif (!empty($value['member_since'])) {
						...
						<div class="row padding align-baseline" id="idd<?= $value['employee_uid']; ?>" style="border:1px solid #f15f43;">
							<div class="col-md-12">
						 <input type="checkbox"  name="a[]" value="<?= base64_decode(base64_decode($value['employee_email'])); ?>"> </div>
						...
						echo $appliedjobs;
						?></div>
							<div class="col-md-2" title="Employee referral">
			...
			<a href="<?= base_url(); ?>admin/search?email=<?= $value['employee_email'];?>&& client=employee"><button type="button" class="btn btn-primary btn-sm">Visit Profile>></button></a>
						...
						?>
						<div class="col-md-12 align-center">
						<button type="Submit" class="btn btn-primary">Send mail</button></div>
					</form>
							</div>
