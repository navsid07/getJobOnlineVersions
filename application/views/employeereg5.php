...
?>
        ...
        <div class="navbar-collapse collapse" id="bs-example-navbar-collapse-1" style="height: 1px;">
         ...
         elseif($countryCookie=='India')
         {
          ...
          ?>
           <ul style="list-style-type:none; margin-top:8px;">
             <li><a href="<?= base_url(); ?>ChangeCookie?country=<?= $cookieValue1; ?>"><img width="5%" title="Switch to canada" src="<?= base_url(); ?>images/canadaflag1.jpg" alt="Indian flag"/></a></li>
          </ul>
          <?php
         }
         ?>
         ...
         <div class="row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-9">
                  ...
                  {
                    ?>
                    <input type="text" name="designation" id="designation" class="form-control input-lg" value="<?= base64_decode(base64_decode($key['employee_designation'])); ?>" />
                    <?php
                  }
                  elseif(empty($key['employee_designation']))
                  {
                    ?>
                    <input type="text" name="designation" id="designation" class="form-control input-lg" placeholder="Your designatyion here" />
                    <?php
                  }
                  ?>
                </div>
  ...
  else
  {
    ...
    $.ajax({
        ...
        else if(response==1)
        {
               ...
               //$("#Loading").hide(200);
              //$("#Successmsg").show(200);
            window.location.href = "<?= base_url(); ?>EmployeeRegistrationStep6";
