 ...
 <div class="col-md-10  ">
     <div class="single background padding">  
	   <div class="form-container">
        ...
        <form id="addArticle" action="<?= base_url(); ?>employee/articleBodyQuery" method="post" enctype="multipart/form-data"> <!--onsubmit="return validateForm()">-->
          <div class="col-md-offset-2 col-md-8" style="margin-bottom:10px; text-align:center;">
             
            </div>

            <input type="hidden" name="uid" value="<?= $result; ?>">
            <div class="row">
            <div class="form-group col-md-12">
                
                
                   <h1> <input type="text" name="articleheading" class="form-control" placeholder="Article Heading Here" id="heading"/>
              </h1>
            </div>
        </div>
        ...
        <div class="row">
            <div class="form-group col-md-12">
                    ...
                    <textarea name="articlebody" id="articlebodyy" rows="20" class="form-control"></textarea>
...
<!-- progress bar-->
  ...
  <div class="row">
         ...
         <br>
        <div class="row">
          <div class="col-md-offset-2 col-md-8 alert alert-success" id="successMsg" style="display: none;">Your article successfully submitted.</div>
        </div>
    ...
    // disabled the submit button
       // $("#addMore").prop("disabled", true);
        ...
        $.ajax({
            ...
            url: "<?php echo base_url('employee/articleBodyQuery'); ?>",
            data: data,
            processData: false,
            contentType: false,
            cache: false,
...
$(document).ready(function () {
    ...
    $("#submit").click(function () {
      ...
      var heading = $("#heading").val();
      var file = $("#file").val();  
      var body = $("#articlebodyy").val();  
             
            // Returns error message when submitted without req fields.  
            if(heading=='' || file=='' || body=='')  
            {  

            
                jQuery("div#err_msg").show(200);  
                jQuery("div#msg").html("All fields are required*");  
            }
            else
            {
