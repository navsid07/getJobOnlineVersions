...
<meta name="keywords" content="job consultants in bathinda, career center, career consultants near me, bathinda job consultant, help me get a job, job recruitment, jobs, part time jobs, job opportunities, job search" />
...
<form action="<?= base_url(); ?>RecruiterVerificationExpiredEmail" method="post">
...
else
{
    ...
    <form action="<?= base_url(); ?>payumoney/payusubmit" style="margin-top:15px;" method="post">
    			<input type="hidden" name="email" value="<?= $key['recruiter_email']; ?>"/>
    			<input type="hidden" name="mobile" value="<?= $key['recruiter_contact']; ?>"/>
				<input type="hidden" name="firstName" value="<?= $key['recruiter_company_name']; ?>"/>
				
				<input type="hidden" name="totalCost" value="500"/>
				<div class="col-md-offset-2 col-md-8">
				<div class="alert alert-info">
						<div style="text-align:center;"><h1>Just one more step to take! </h1></div></br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspYou have reached the last step of the registration process on get job online Recruiter portal.You have to deposit a small
amount of Rs.500 as a token of due diligence.This is not a membership fee of any sorts.  This will be considered as your account balance.  This is just the balance to spend on finding the recruiteaccording to your needs.  You can check your balance and spendings in your profile.You can add more amount by clicking on add funds.	</br></br><div style="text-align:center;"><input type="submit" class="verifybtn" Value="Finish Registration"><a href="<?= base_url(); ?>RecruiterPayLater/<?php echo $email; ?>"><button type="button" style="margin-left:10px;" class="verifybtn">May be later</button></a></div>
