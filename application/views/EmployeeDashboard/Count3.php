	...
	<table width="100%" class="background" style="margin-top:7%; border-collapse: collapse; ">
		...
		foreach ($employeeExperience as $experienceValue)
			...
			?>
				...
				<table width="100%" class="background" style="margin-top:7%; -webkit-box-shadow: 0 2px 4px rgba(0, 0, 0, .1);
...
<div class="col-md-12 col_3">
	<table width="100%" class="background" cellpadding="10" >
		<th colspan="3"></th>
		<tbody>
	...
	?>
	 ...
	 <div class="col_3" style=" padding:3px;">
	<table width="100%" class="background" style="border-collapse: collapse;">
		<th colspan="3"></th>
