	    ...
	    <div class="navbar-collapse collapse" id="bs-example-navbar-collapse-1" style="height: 1px;">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                 ...
                 <li><a href="<?= base_url(); ?>AdminAgain/allrecruiter" >All recruiter</a></li>
                         ...
                         <li><a href="<?= base_url(); ?>admin/checkBoxmailAllrecruiter" >Send Checkbox emails</a></li>
            ...
            <li class="dropdown">
                ...
                <li><a href="<?= base_url(); ?>AdminAgain/allemployer" >All employee</a></li>
                        ...
                        <li><a href="<?= base_url(); ?>admin/checkBoxmailAllemployee" >Send Checkbox emails</a></li>
	    ...
	    <!--/.navbar-collapse-->
				...
				<div class="row">
					...
					<table width="100%" style="text-align: center;" class="background col_3">
						<tr><td><h3 class="radius">Reports</h3></td></tr>
						<?php
						...
						{
						foreach ($reportdetail as $valuee) {
							
						?>
						<tr><td><?= $valuee['report'];?></td></tr>
						<?php
					}
				}
						?>
					...
					<table width="100%" style="text-align: center;" class="background col_3">
						<tr><td><h3 class="radius">Report by</h3></td></tr>
						<?php
						if(empty($employer))
						{
							?>
<tr><td>Sorry no result found.</td></tr>
						...
						?>
						<tr><td><a href="<?= base_url(); ?>admin/search?email=<?= $value['employee_email']; ?>&&client=employee"><?= base64_decode(base64_decode($value['employee_name'])); ?></a></td></tr>
						<?php
					}
				}
						?>
					...
					<div class="row">
						<div class="col-lg-7 " style="text-align:center; margin-top:5%; margin-bottom:3%; padding:6px;">
					<table width="100%" style="text-align: center;" class="background col_3">
						<tr><td><h3 class="radius">More Reports</h3></td></tr>
						<?php
						if(empty($reports))
						{
							?>
						...
						{
						foreach ($reports as $valuee) {
							
						?>
						<tr><td><a href="<?= base_url(); ?>admin/search?email=<?= $valuee['employee_email']; ?>&&client=employee"><?= $valuee['report'];?></td></tr>
						<?php
					}
				}
						?>
