	    ...
	    <!--/.navbar-collapse-->
				...
				<div class="container">
					<div class="row" style="margin-top:4%;">
						...
						?>
						<div class="col-md-3" style="text-align:center; margin-bottom:4%;">
							<a href="fetchemployer?uid=<?= $value['employee_uid']; ?>">
								<img src="<?= base_url();?>images/getjobb.png"></br>
						
 					
 	<?php
						
								$email1=base64_decode(base64_decode($value['employee_name']));
								$qualification=base64_decode(base64_decode($value['employee_email']));
