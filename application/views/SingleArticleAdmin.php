	...
	<div class="container">
	    ...
	    <!--/.navbar-collapse-->
				...
				foreach ($article as $key) {
					?>
					<h3 class="radius"><?= base64_decode((base64_decode($key['employee_articleHeading']))); ?></h3>
					<p><?= base64_decode(base64_decode($key['employee_articleBody'])); ?></p>
					<?php
				}
				?>
				...
				<div class="col-lg-5" style="text-align:center; margin-top:5%; margin-bottom:3%;">
					<table class="col_3 cool margin-bottom" width="100%">
						<th><h3 class="radius">Submitted by</h3></th>
						
							<?php
							if(!empty($submitter))
							{
							foreach ($submitter as $value) {
								?>
								<tr><td class="padding">
									<a href="<?= base_url(); ?>admin/search?email=<?= $value['employee_email']; ?>&&client=employee"><?=
									base64_decode(base64_decode($value['employee_name']));
									?></a>
								</td></tr>
								<?php
							}
...
?>
				<div class="col-lg-7" style="text-align:center; margin-top:5%; margin-bottom:3%;">
					<table class="col_3 cool margin-bottom" width="100%" style="text-align: center;">
...
?>
						...
						<div class="col-lg-5" style="text-align:center; margin-top:5%; margin-bottom:3%;">
					<table class="col_3 cool margin-bottom" width="100%">
						<th><h3 class="radius">Reports on this article</h3></th>
